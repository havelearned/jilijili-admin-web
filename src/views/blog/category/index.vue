        ...
        <q-table
          ...
          <template #body-cell-opt="props">
            <q-td :props="props" :auto-width="true">
              ...
              <btn-del :label="props.row.title" @confirm="delPlus(props.row.categoryId)"/>
            </q-td>
          </template>
        ...
        <q-form @submit="submit" class="dialog_card  q-ma-sm">
          ...
          <q-scroll-area class="column" style="height: 80%">
            <div class="row q-col-gutter-x-md dialog_form q-pa-md">
              ...
              <div class="col-6">
                <h5>分类排序:</h5>
                <q-input outlined dense square clearable v-model="form.categoryOrder"
                         type="number" />
              </div>
            </div>
          </q-scroll-area>
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      visibleColumns: ['index','childId',  'title','categoryOrder', 'createdTime', 'opt'],
      columns: [
        {name: 'index', align: 'center', label: '序号', field: 'index',},
        {name: 'categoryId', align: 'center', label: '分类Id', field: 'categoryId',},
        {name: 'childId', align: 'center', label: '子分类Id', field: 'childId',},
        {name: 'title', align: 'center', label: '分类名称', field: 'title',},
        {name: 'categoryOrder', align: 'center', label: '排序', field: 'categoryOrder',},
      ...
      url: {
        ...
        deleteBatch: '/blog/category',
        exportXlsUrl: '/blog/category/export',
        importExcelUrl: '/blog/category/import',
        getImportTemplate: '/blog/category/get/exportTemplate',
      },
    }
  },
  mounted() {
  ...
  methods: {
    ...
    m_deleteBatch(){
      this.selected = this.selected.map(item=>item.categoryId)
