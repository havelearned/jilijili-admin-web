     ...
     <div class="col bg-white shadow-2 q-pa-md q-ma-sm">
       ...
       >
           ...
           <div class="row no-wrap full-width">
             <div class="column q-pa-xs">
               <q-input outlined dense placeholder="请输入商品名称搜索" class="on-left"
                 ...
                 <q-select label="分类"  dense square clearable rounded map-options emit-value
                           use-input
             ...
             <div class="q-gutter-xs">
               <router-link tag="a" :to="'/goods'" target="_blank"><q-btn label="数字产品发布" /></router-link>
               <q-btn icon="add" no-wrap color="primary" label="发布新商品" @click="add"/>
               <q-btn
         ...
         <template #body-cell-imageUrl="props">
           <q-td :props="props" >
             <q-img fit="cover" :src="props.row.imageUrl" style="width: 5vmin;height: 5vmin">
...
import CategoriesDialog from "@/components/dialog/categoriesDialog.vue";
...
export default {
  ...
  methods: {
    ...
    requiredTest,
    initDict() {
      this.group =['index','categoryId','productName','description','price','stockQuantity','imageUrl','createdTime','opt',]
