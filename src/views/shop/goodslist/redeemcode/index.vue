<template>
  <div>
    <div class="col bg-white shadow-2 q-pa-md q-ma-sm">
      <q-table flat color="primary" class="cross_table"
        ...
        <template v-slot:top="table">
          <div class="row no-wrap full-width q-gutter-xs">
            ...
            <div class="q-gutter-xs">
              ...
              <q-btn icon="add" no-wrap color="primary" label="批量生成" @click="add"/>
        ...
        <template #body-cell-promoCode="props">
          <q-td :props="props" auto-width>
            <q-btn :label="props.row.promoCode" flat square @click="copyText(props.row.promoCode)">
        ...
        <template #body-cell-opt="props">
          <q-td :props="props" auto-width>
              <q-btn v-if="!props.row.isUsed" label="绑定优惠卷"
                     square dense color="primary" icon="attachment" @click="my_EditBefore(props.row)">
              </q-btn>
              <btn-del v-if="props.row.isUsed" :label="props.row.title" @confirm="deleted(props.row)"/>
          </q-td>
        </template>
      </q-table>
    </div>
      ...
      <q-form @submit="submit" class="dialog_card  q-ma-sm">
        ...
        <q-scroll-area class="column" style="height: 80%">
          <div class="row q-col-gutter-x-md dialog_form q-pa-md">
            <div class="col-6">
              <h5>选择优惠卷:</h5>
              <q-select outlined dense square clearable use-chips map-options emit-value
    ...
    <couponDialog ref="couponDialog"> </couponDialog>
